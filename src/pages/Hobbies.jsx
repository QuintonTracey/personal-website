  ...
  return (
    <>
      ...
      <PageGlowContainer title="My Hobbies" glowColor={green} className="green-scroll" onEsc={() => navigate('/') }>
        <h2 style={{ fontSize: '2rem', color: green, marginBottom: '1.2rem', fontFamily: 'inherit', letterSpacing: 1 }}>Hobbies</h2>
        <p style={{ marginBottom: '2.2rem', fontSize: '1.1rem', color: '#fff', textAlign: 'center', fontFamily: bodyFont }}>
