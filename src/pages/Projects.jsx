  ...
  return (
    <>
      ...
      <PageGlowContainer title="My Projects" glowColor={blue} className="blue-scroll" onEsc={() => navigate('/') }>
        <h2 style={{ fontSize: '2rem', color: blue, marginBottom: '1.2rem', fontFamily: 'inherit', letterSpacing: 1 }}>Projects</h2>
        <p style={{ fontSize: '1.2rem', color: '#fff', marginBottom: '1.2rem', fontFamily: bodyFont, letterSpacing: 1 }}>
          Here are some of the latest projects I've worked on. For more information on a specific project, click on its icon. For a complete list of github projects, check out my <a href="https://github.com/QuintonTracey" style={{ color: blue, textDecoration: 'none' }}>GitHub</a>.
        </p>
